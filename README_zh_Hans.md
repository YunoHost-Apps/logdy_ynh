...
[![集成程度](https://apps.yunohost.org/badge/integration/logdy)](https://ci-apps.yunohost.org/ci/apps/logdy/)
![工作状态](https://apps.yunohost.org/badge/state/logdy)
![维护状态](https://apps.yunohost.org/badge/maintained/logdy)
